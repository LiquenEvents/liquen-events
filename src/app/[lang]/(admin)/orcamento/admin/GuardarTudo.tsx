        ...
        >
          <div className="flex items-start gap-2">
            ...
            <button
              ...
              aria-label="Fechar"
              className="alvo-toque -mt-1 -mr-1 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-foreground/35 hover:bg-[var(--bo-tinta-6)] hover:text-foreground/70"
            >
              <svg
                width="13"
                height="13"
