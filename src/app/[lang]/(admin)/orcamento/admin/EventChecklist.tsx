  ...
  return (
    ...
    <section className="border-t border-[var(--bo-hairline-strong)] pt-[var(--bo-p-vista)]">
      <div className="mb-5 flex items-center justify-between gap-3">
        ...
        {items.length > 0 && (
          <span className="shrink-0 rounded-full bg-[var(--bo-tinta-6)] px-2.5 py-1 text-[11px] tabular-nums text-foreground/55">
      ...
      {items.length === 0 ? (
        ...
        <>
          ...
          <div className="mb-3 flex flex-wrap items-center justify-between gap-x-3 gap-y-1.5">
            <div className="flex items-center gap-1">
              <button
                ...
                className="alvo-toque rounded-lg px-2 py-1 text-[11px] tracking-[0.02em] text-foreground/45 hover:bg-[var(--bo-tinta-6)] hover:text-foreground/75 disabled:pointer-events-none disabled:opacity-40 motion-safe:transition-colors"
              >
                Marcar todas
              </button>
              {doneCount > 0 && (
                <button
                  ...
                  className="alvo-toque rounded-lg px-2 py-1 text-[11px] tracking-[0.02em] text-foreground/45 hover:bg-[var(--bo-tinta-6)] hover:text-foreground/75 motion-safe:transition-colors"
                >
                  Limpar concluídas
                </button>
              )}
          ...
          {anular && (
            <div
              role="status"
              className="mb-3 flex flex-wrap items-center gap-2 rounded-xl bg-[var(--bo-tinta-6)] px-3 py-2 text-xs text-foreground/70"
            >
