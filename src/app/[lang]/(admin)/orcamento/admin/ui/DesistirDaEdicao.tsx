...
export function DesistirDaEdicao({
  ...
  return (
    <button
      ...
      className={`alvo-toque flex h-6 w-6 shrink-0 items-center justify-center rounded-md text-sm leading-none text-foreground/40 hover:bg-[var(--bo-tinta-6)] hover:text-foreground/70 active:bg-[var(--bo-tinta-10)] ${ESTADO} ${PRESSAO} ${className}`}
    >
