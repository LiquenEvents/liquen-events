...
export default function Image() {
  return new ImageResponse(
    (
      ...
      >
        {/* Subtle moss radial glow — bottom-left */}
        <div
          style={{
            position: "absolute",
            bottom: 0,
            ...
            width: "600px",
            height: "400px",
            background: `radial-gradient(ellipse at 0% 100%, rgba(124,133,75,0.18) 0%, transparent 65%)`,
            pointerEvents: "none",
          }}
        />
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          <div
            style={{ width: "28px", height: "1px", background: GOLD, flexShrink: 0 }}
          />
          <span
            style={{
              fontSize: "12px",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
            <div
              style={{ width: "36px", height: "1px", background: `${GOLD}60`, flexShrink: 0 }}
            />
            <span
              style={{
                fontSize: "17px",
        ...
        >
          <span
            style={{ fontSize: "10px", color: "rgba(255,255,255,0.18)", letterSpacing: "4px", textTransform: "uppercase" }}
          >
            desde
          </span>
          <span
