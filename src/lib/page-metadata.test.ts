...
describe("pageMetadata", () => {
  ...
  it("declares the reciprocal PT/EN hreflang set", () => {
    const meta = pageMetadata({ title: "T", description: "D", path: "/servicos", locale: "pt" });
  ...
  it("self-canonicalises to the /en mirror when the locale is English", () => {
    const meta = pageMetadata({ title: "T", description: "D", path: "/servicos", locale: "en" });
