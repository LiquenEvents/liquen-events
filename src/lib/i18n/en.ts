...
export const en: Dict = {
  ...
  orcamento: {
    ...
    phPessoas: "e.g. 120",
    labelPessoasEstimativa: "Roughly how many?",
    phPessoasEstimativa: "e.g. between 100 and 150",
    hintPessoasEstimativa: "A range is enough. It only helps us size the proposal.",
    ...
    errPessoasEstimativa: "Give us an estimate. A range is fine.",
