...
export const en: Dict = {
  ...
  home: {
    ...
    areasTitleLine1: "Events in Lisbon",
    areasTitleLine2: "and across Portugal",
    areasText:
      "Weddings, corporate events and celebrations — from concept to execution, we handle every detail so all you have to do is live the moment.",
    areasTags: [
      "Weddings in the Alentejo",
