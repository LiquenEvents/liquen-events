...
import { Repository, FileBackend, SupabaseBackend, type Mapper, type Backend } from "./repository";
...
describe("store mappers round-trip through toRow → DB → fromRow", () => {
  it("tasks", async () => {
    ...
    const row = { ...mapper.toRow({
      id: "t1", title: "Ligar ao cliente", done: false, priority: "alta",
      dueDate: "2026-06-01", quoteId: "Q1", clientName: "Ana", assignee: "Rui",
      area: "comercial", createdAt: "2026-01-01T00:00:00.000Z",
    } as any), created_at: "2026-01-01T00:00:00.000Z" };
  ...
  it("suppliers", async () => {
    ...
    const supplier = {
      id: "s1", name: "Floristaria", category: "Flores", email: "f@x.pt",
      phone: "910000000", location: "Lisboa", notes: "Rápidos",
      createdAt: "2026-01-01T00:00:00.000Z",
    };
  ...
  it("calendar events", async () => {
    ...
    const event = {
      id: "c1", date: "2026-07-04", title: "Casamento", kind: "evento" as const,
      time: "16:00", note: "Quinta", createdAt: "2026-01-01T00:00:00.000Z",
    };
