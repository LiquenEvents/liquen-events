...
const CHUNK_MARKERS = [
  ...
  ["Tarefas", "Não foi possível criar a tarefa. Tenta novamente."],
  ...
  ["EventCosts", "Não foi possível guardar o custo. Tenta novamente."],
  ...
  ["EventChecklist", "Não foi possível guardar a checklist. Tenta novamente."],
